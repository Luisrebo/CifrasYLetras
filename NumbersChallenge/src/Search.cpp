...
Search::Search(num_t nObjetivo, const std::array<num_t, CIFRAS_INICIALES>& nCandidatos)
	: numObjetivo(nObjetivo), numerosCandidatos(nCandidatos), statsPtr(nullptr), verticeOrigen(0, std::array<num_t, CIFRAS_MAXIMAS_ENCADENADAS>{},
		std::array<char, CIFRAS_INICIALES>{}, nCandidatos), sol(verticeOrigen, 0, 0), mejorSolucion(0) {}
