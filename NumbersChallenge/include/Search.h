...
protected:
	...
	Problema verticeOrigen{ 0,std::array<num_t, CIFRAS_MAXIMAS_ENCADENADAS>{},std::array<char, CIFRAS_INICIALES>{},
		std::array<num_t, CIFRAS_INICIALES>{}
	};

	Solucion sol{ verticeOrigen, 0, 0 };

	num_t mejorSolucion{ 0 };

	const std::array<Operacion, 4> OPERACIONES = {
