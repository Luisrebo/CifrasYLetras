#ifndef PROBABILITY_ORDER_HEURISTIC_H
#define PROBABILITY_ORDER_HEURISTIC_H

#include "IHeuristic.h"
#include <functional>

class ProbabilityOrderHeuristic : public IHeuristic {

public:

	ProbabilityOrderHeuristic(MatricesDeProbabilidades const& matrizProbs) : matrizProbabilidades(matrizProbs) {}
	...
	virtual ~ProbabilityOrderHeuristic() = default;
