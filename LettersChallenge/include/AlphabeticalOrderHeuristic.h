#ifndef ALPHABETICAL_ORDER_HEURISTIC
#define ALPHABETICAL_ORDER_HEURISTIC
...
//En esta Heuristica recorremos primero los nodos representados por caracteres menores
class AlphabeticalOrderHeuristic : public IHeuristic {
public:
	...
	virtual ~AlphabeticalOrderHeuristic() = default;
