...
void ReachableWordsHeuristic::prepararAtributosHeuristicaNodo(Trie::Link nodo) {

	prepararPalabrasAlcanzablesHeuristicaNodo(nodo);
}

//vamos recorriendo y expandiendo hacia arriba las plabras alcanzables
int ReachableWordsHeuristic::prepararPalabrasAlcanzablesHeuristicaNodo(Trie::Link nodo) {
...
void ReachableWordsHeuristic::ordenaVectorHijosSegunHeuristica(Trie::Link nodo) const {
